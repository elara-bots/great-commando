...
class RichDisplay {
	 ...
	 * @since 0.4.0
	 * @param {external:RichEmbed} [embed=new RichEmbed()] A Template embed to apply to all pages
	 */
	constructor(embed = new Embed()) {
		/**
		 * The embed template
		 * @since 0.4.0
		 * @type {external:RichEmbed}
		 */
	 ...
	 * @since 0.4.0
	 * @param {(Function|external:RichEmbed)} embed A callback with the embed template passed and the embed returned, or an embed
	 * @returns {this}
	 * @chainable
	 */
	addPage(embed) {
	 ...
	 * @since 0.4.0
	 * @param {CommandoMessage} message A message to either edit, or use to send a new message for this RichDisplay
	...
	/**
	 * Resolves the callback or RichEmbed into a RichEmbed
	 * @since 0.4.0
	 * @param {(Function|external:RichEmbed)} cb The callback or embed
	 * @returns {external:RichEmbed}
	 * @private
	 */
